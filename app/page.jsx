...
export default function Home() {
  ...
  // top 5 by views for slider
  const top5 = [...anime].sort((a, b) => (b.views ?? 0) - (a.views ?? 0)).slice(0, 5);
    ...
    <div className="min-h-screen max-w-sm mx-auto" style={{ background: "#0D1117", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="sticky top-0 z-40 flex items-center justify-between px-4 py-3"
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-white font-black text-base">AniIndex</span>
        </div>
      ...
      <div style={{ overflowY: "auto", scrollbarWidth: "none" }}>
        ...
        {loading && (
          <div className="flex flex-col items-center justify-center py-20 gap-3">
            ...
            <p className="text-gray-500 text-sm">Loading anime...</p>
          </div>
        )}
        ...
        {!loading && anime.length === 0 && (
          <div className="text-center py-20 px-8">
            ...
            <p className="text-white font-bold text-base">Koi anime nahi mila</p>
            <p className="text-gray-500 text-sm mt-1">Bot se /add karke anime add karo</p>
          </div>
        )}
        ...
        <div className="mt-5 pb-10">
          ...
          {!loading && anime.length > 0 && sortedSections.length === 0 && (
            <div className="text-center py-20 px-8">
              <div className="text-5xl mb-3">🔍</div>
              <p className="text-white font-bold">"{search}" nahi mila</p>
              <p className="text-gray-500 text-sm mt-1">Kuch aur try karo</p>
            </div>
          )}
        </div>
      </div>
